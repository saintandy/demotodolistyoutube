"""
Django settings for demotodolist project.
...
AUTH_USER_MODEL = "demotodolistapp.User"
...
ROOT_URLCONF = 'demotodolist.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                "demotodolistapp.context_processor.default",
            ],
        },
    },
]
...
PUBLIC_STATE_PATHS = [
    (
        os.path.join(PROJECT_ROOT, "demotodolistapp/templates/PublicState.jstemplate"),
        os.path.join(PROJECT_ROOT, "demotodolistapp/static/js/PublicState.js")
    ),
]
...
WSGI_APPLICATION = 'demotodolist.wsgi.application'
